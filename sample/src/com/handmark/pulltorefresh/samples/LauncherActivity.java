...
public class LauncherActivity extends ListActivity {
	...
	public static final String[] options = { "ListView", "ExpandableListView", "GridView", "WebView", "ScrollView",
			"Horizontal ScrollView", "ViewPager", "ListView Fragment", "WebView Advanced", "ListView in ViewPager","Change Top" };
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		switch (position) {
			...
			case 9:
				...
				break;
			case 10:
				intent = new Intent(this, PullToChangeTopActivity.class);
				break;
		}
